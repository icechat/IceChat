...
namespace IceChatPlugin
{
    public partial class FormHighLite : Form
    {
        ...
        {
            textNickMatch.ForeColor = IrcColor.colors[colorSelected];
            textHostMatch.ForeColor = IrcColor.colors[colorSelected];
            textNickMatch.Tag = colorSelected;
        }

        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            highLiteItem.Match = textNickMatch.Text;            
            
            highLiteItem.Color = (int)textNickMatch.Tag;

            highLiteItem.MatchHost = textHostMatch.Text;
