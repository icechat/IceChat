...
call %msBuildDir%\msbuild.exe  ..\src\IceChat\IceChat9-45-VS2015-x86.sln /p:Configuration=Release /p:Platform="Any CPU" /l:FileLogger,Microsoft.Build.Engine;logfile=Manual_MSBuild_ReleaseVersion_LOG.log
set msBuildDir=
