...
namespace IceChat
{
    public partial class TextWindow : UserControl
    {
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (_startHighLine == _curHighLine)
                {
                    ...
                    //System.Diagnostics.Debug.WriteLine(_startX + ":" + e.X + ":Selection " + _curHighChar + "::" + _displayLines[_curHighLine].startSelection);
                    ...
                    else
                    {
                        ...
                        //System.Diagnostics.Debug.WriteLine("select to the right:" + _displayLines[_curHighLine].selectionX1 + ":" + +_displayLines[_curHighLine].selectionX2);
                    }
        ...
        {            
            try
            {
                if (lineNumber < _totaldisplayLines && lineNumber >= 0)
                {
                    ...
                    //g.SmoothingMode = SmoothingMode.HighSpeed;    default
        ...
        private int ReturnChar(int lineNumber, int x)
        {
            try
            {
                if (lineNumber < _totaldisplayLines && lineNumber >= 0)
                {
                    ...
                    //System.Diagnostics.Debug.WriteLine("line1:" + line.Length + ":" + x + ":" + width  + ":" + line);
                    ...
                    //line = StripAllCodes(_displayLines[lineNumber].line, true);
                    //System.Diagnostics.Debug.WriteLine("line2:" + line.Length + ":" + line);
                    ...
                    for (int i = 0; i < line.Length; i++)
                    {
                        ...
                        if (line[i] == boldChar || line[i] == cancelChar || line[i] == italicChar || line[i] == underlineChar || line[i] == urlStart || line[i] == urlEnd)
                        {
                            //System.Diagnostics.Debug.WriteLine("control char");
                            controlChars++;
        ...
        {
            _font = new Font(this.Font.Name, this.Font.Size, FontStyle.Regular, GraphicsUnit.Point);
            _boldFont = new Font(this.Font.Name, this.Font.Size, FontStyle.Bold, GraphicsUnit.Point);
            _underlineFont = new Font(this.Font.Name, this.Font.Size, FontStyle.Underline, GraphicsUnit.Point);
        ...
        private int FormatLines(int startLine, int endLine, int line)
        {
            ...
            //System.Diagnostics.Debug.WriteLine(displayWidth + ":" + (_oldWidth - vScrollBar.Width - 10);
            //System.Diagnostics.Debug.WriteLine("start:" + startLine + ":" + endLine + ":" + line);
            ...
            for (int currentLine = endLine; currentLine <= startLine; currentLine++)
            {
                ...
                else
                {
                    ...
                    //System.Diagnostics.Debug.WriteLine("remainder:" + buildString.ToString());
        ...
        private void OnDisplayText(PaintEventArgs e)
        {
            ...
            try
            {
                ...
                // http://msdn.microsoft.com/en-us/library/ssazt6bs(v=vs.90).aspx
                ...
                //g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SystemDefault;   //default (no blur)
                
                g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAliasGridFit;
                //g.TextRenderingHint = System.Drawing.Text.TextRenderingHint.AntiAlias;      //blurry text
                ...
                //Font font = new Font(this.Font.Name, this.Font.Size, FontStyle.Regular, GraphicsUnit.Point);    //default
                //Font font = new Font(this.Font.Name, this.Font.Size, FontStyle.Regular, GraphicsUnit.Pixel);
                //Font font = this.Font;
                Font font = _font;
                ...
                while (lineCounter < LinesToDraw)
                {
                    ...
                    if (!isInUrl)
                    {
                        ...
                        //font = new Font(this.Font.Name, this.Font.Size, FontStyle.Regular, GraphicsUnit.Pixel);
                        font = _font;
                    }
                    if (line.Length > 0)
                    {
                        do
                        {
                            ...
                            switch (ch[0])
                            {
                                ...
                                case urlStart:
                                    ...
                                    //font = new Font(this.Font.Name, this.Font.Size, FontStyle.Underline, GraphicsUnit.Pixel);
                                    font = _underlineFont;
                                    isInUrl = true;
                                ...
                                case boldChar:
                                    ...
                                    //font = new Font(this.Font.Name, this.Font.Size, fsb, GraphicsUnit.Pixel);
                                ...
                                default:
                                    ...
                                    {
                                        //System.Diagnostics.Debug.WriteLine("X1:" + curChar + ":" + ch[0] + ":" + (int)ch[0] + ":" + isInSelection);
                    ...
                    if (i == line.Length && line.Length > 0)
                    {
                        if (buildString.Length > 0)
                        {
                            ...
                            //System.Diagnostics.Debug.WriteLine("left:" + startX + ":" + startY + ":" + curForeColor + ":" + buildString.ToString());
                            g.DrawString(buildString.ToString(), font, new SolidBrush(IrcColor.colors[curForeColor]), startX, startY, stringFormat);
                        }
                    }
        ...
        private float MeasureString(string data, Graphics g, bool startBold)
        {
            ...
            //Font boldFont2 = new Font(this.Font.FontFamily, this.Font.Size, GraphicsUnit.Point);
            //Font boldFont2 = new Font(this.Font.Name, this.Font.Size, FontStyle.Bold , GraphicsUnit.Point);
            ...
            for (int i = 0; i < data.Length; i++)
            {
                ...
                {
                    size += (float)g.MeasureString(StripAllCodes(line, true), isBold? _boldFont : _font, 0, stringFormat).Width;
                    isBold = !isBold;
                    line = "";
                }
                else
            ...
            //System.Diagnostics.Debug.WriteLine(size + ":" + data);
            return size;
        }
